...
<div class="new-item m-b-30">
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('homework_subject_teacher/homework'); ?>" ><i class="fa fa-tasks"></i> All Homework</a>
</div>
		
<?php 
echo form_open_multipart('homework_subject_teacher/new_homework_action/'.$class_id); ?>
