	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<?php echo form_open_multipart('prs_staff/initiate_request_action'); ?>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group">
							...
							<input type="text" name="acc_number" value="<?php echo set_value('acc_number', $staff_details->acc_number); ?>" class="form-control numbers-only" required maxlength="10" />
						...
						<?php } else { ?>
							...
							<div class="form-group">
								...
								<input type="text" name="bank_name" value="<?php echo set_value('bank_name', $staff_details->bank_name); ?>" class="form-control" required />
								<div class="form-error"><?php echo form_error('bank_name'); ?></div>
							</div>
