jQuery(document).ready(function ($) {
 "use strict";
	...
	var pending_requests_table = $('#pending_requests_table').DataTable({ 
		...
		ajax: {
			url: base_url + 'prs_admin/pending_requests_ajax/' + session + '/' + term,
			dataType: "json",
			type: "POST",
	...
	var approved_requests_table = $('#approved_requests_table').DataTable({ 
		...
		ajax: {
			url: base_url + 'prs_admin/approved_requests_ajax/' + session + '/' + term,
			dataType: "json",
			type: "POST",
			data: { 'q2r_secure' : csrf_hash } //cross site request forgery protection
		},
	...
	var declined_requests_table = $('#declined_requests_table').DataTable({ 
		...
		ajax: {
			url: base_url + 'prs_admin/declined_requests_ajax/' + session + '/' + term,
			dataType: "json",
			type: "POST",
			data: { 'q2r_secure' : csrf_hash } //cross site request forgery protection
		},
	...
	var requests_table = $('#requests_table').DataTable({ 
		...
		ajax: {
			url: base_url + 'prs_admin/requests_ajax/' + session + '/' + term,
			dataType: "json",
			type: "POST",
			data: { 'q2r_secure' : csrf_hash } //cross site request forgery protection
		},
