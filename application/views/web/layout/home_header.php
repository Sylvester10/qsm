      ...
      <nav id="nav-menu-container">
        <ul class="nav-menu">
          ...
          <li class="menu-has-children"><a class="text-white">About</a>
            <ul>
              <li><a href="#about">About <?php echo software_initials; ?></a></li>
              ...
              <li><a href="#product_screenshots">Screenshots</a></li> 
            </ul>
          </li>
  ...
  <div class="body">
    ...
    <div class="jumbotron jumbotron-fluid" id="banner" style="background-image: url(<?php echo base_url(); ?>assets/web/img/background.jpg);">
      <div class="container text-center text-md-left">
        ...
        <h1 data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="display-3 text-white font-weight-bold">
          <?php echo software_name; ?>
        </h1>

        <p data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="lead text-white">
          Easy to use Complete School Management System.
        </p>
        <a href="<?php echo base_url('install'); ?>" data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="btn my-4 font-weight-bold atlas-cta cta-green">Start Using Free</a>
        <a href="<?php echo base_url('demo/login'); ?>" data-aos="fade" data-aos-easing="linear" data-aos-duration="1000" data-aos-once="true" class="btn my-4 font-weight-bold atlas-cta cta-green">View Demo</a>
      </div>
    </div>
