...
<?php echo custom_validation_errors(); ?>
	...
	if ( ! $general_announcement ) { //has not been created ?> 
		...
		<?php require("application/views/staff/publications/modals/create_general_announcement.php");  ?>
	...
	<?php } else { //has been created ?>
		...
		<?php require("application/views/staff/publications/modals/update_general_announcement.php");  ?>


		<?php 
		//delete confirm
		$delete_confirm = modal_delete_confirm($general_announcement->id, 'General Announcement', 'announcement', 'publications_staff/delete_general_announcement');
		echo $delete_confirm;
