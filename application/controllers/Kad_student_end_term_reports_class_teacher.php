...
/* ===== Documentation ===== 
Name: Kad_student_end_term_reports_class_teacher
Role: Controller
...
class Kad_student_end_term_reports_class_teacher extends MY_Controller {
    ...
    public function delete_skill_score($skill_score_id) {
        $t = $this->kad_students_end_term_report_model->get_skill_score_details($test_score_id);
        $session = $t->session;
        $term = $t->term;
        $class_id = $t->class_id;
        $student_id = $t->student_id;
