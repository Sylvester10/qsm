...
/* ===== Documentation ===== 
Name: Imported_students_model_ajax
Role: Ajax model for jQuery DataTables
Description: Handles ajax DB processes of imported students in admin's dashboard
Controller: Imported_students
Author: Nwankwo Ikemefuna
Date Created: 13th August, 2018
*/


class Imported_students_model_ajax extends CI_Model {
	...
	public function actions($id) {
		return '<p><a type="button" class="btn btn-default btn-sm btn-block action-btn clickable" href="' . base_url('student_import/edit_student/'.$id) .'"> <i class="fa fa-pencil" style="color: green"></i> &nbsp; Edit Student </a></p>
	...
	public function modal_options($id) {
		$fullname = $this->student_import_model->get_imported_student_fullname($id);
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="' .base_url('student_import/delete_student/'.$id). '"> Yes, Delete </a>
