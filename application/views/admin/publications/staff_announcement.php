...
<?php echo custom_validation_errors(); ?>
	...
	if ( ! $staff_announcement ) { //has not been created ?> 
		...
		<?php require("application/views/admin/publications/modals/create_staff_announcement.php");  ?>
	...
	<?php } else { //has been created ?>
		...
		<?php require("application/views/admin/publications/modals/update_staff_announcement.php");  ?>


		<?php 
		//delete confirm
		$delete_confirm = modal_delete_confirm($staff_announcement->id, 'Staff Announcement', 'announcement', 'publications_admin/delete_staff_announcement');
		echo $delete_confirm;
