		...
		<div class="modal-dialog">
			<div class="modal-content modal-form-sm">
				...
				<div class="modal-body">
					...
					echo form_open('publications_admin/create_calendar_date_ajax', $form_attributes); ?>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a class="btn btn-sm btn-danger" role="button" href="<?php echo base_url('publications_admin/clear_calendar_dates'); ?>"> Yes, Clear All </a>
