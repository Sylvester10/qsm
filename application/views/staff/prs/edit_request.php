...
<?php echo flash_message_danger('status_msg_error'); ?>
	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<?php echo form_open_multipart('prs_staff/edit_request_action/'.$y->id); ?>
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group">
							...
							<?php } else { ?>
								...
								<a href="<?php echo base_url('prs_staff/delete_request_content/'.$y->id); ?>" title="Delete if a file is no longer required/necessary for this request"> &nbsp; Delete?</a> <br />
