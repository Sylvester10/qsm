...
/* ===== Documentation ===== 
Name: Student_users_model_ajax
Role: Ajax model for jQuery DataTables
Description: Handles ajax DB processes of demo student users
...
class Student_users_model_ajax extends CI_Model {
	...
	public function actions($id) {
		return '<p><a type="button" href="' . base_url('demo_accounts/super_user_login_student/'.$id) .'" class="btn btn-default btn-sm btn-block action-btn clickable" target="_blank"> <i class="fa fa-sign-in" style="color: green"></i> &nbsp; Login as Super User </a></p>
	...
	public function modal_options($id) {
		$fullname = $this->common_model->get_student_fullname($id);
	...
	private function demo_roles($demo_role) {
		//get student demo roles
		$roles = demo_roles_student();
		$role_options ="";
	...
	public function edit_student_form($id) {
		...
		return form_open('demo_accounts/edit_student/'.$id).
			'<div class="m-b-10">
	...
	public function modal_edit_student($id) {
		$y = $this->common_model->get_student_details_by_id($id);
					...
					<div class="modal-dialog">
						<div class="modal-content modal-form-sm">
							<div class="modal-header">
								...
								<h4 class="modal-title">Edit: ' . $student_name . '</h4>
							</div><!--/.modal-header-->
							<div class="modal-body">'
								. $this->edit_student_form($id) .
							'</div>
						</div>
					</div>
				</div>';
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="' .base_url('demo_accounts/delete_student/'.$id). '"> Yes, Delete </a>
