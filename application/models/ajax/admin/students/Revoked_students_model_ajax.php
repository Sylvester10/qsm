...
/* ===== Documentation ===== 
Name: Revoked_students_model_ajax
Role: Ajax model for jQuery DataTables
Description: Handles ajax DB processes of revoked students in admin's dashboard
Controller: Admin
...
class Revoked_students_model_ajax extends CI_Model {
	...
	var $order = array('date_revoked' => 'desc'); 
	...
	function get_records() {
		...
		$this->db->where(array('school_id' => school_id, 'revoked' => 'true'));
	    $query = $this->db->get();
		return $query->result();
	}
