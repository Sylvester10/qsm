	...
	echo modal_bulk_actions('school_account/bulk_actions_schools', $options_array); ?>
		...
		<table id="free_trial_schools_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
			...
			<thead>
				<tr>
					...
					<th class="min-w-150"> Date Expiring</th>
					<th class="min-w-150"> Time Remaining </th>
				</tr>
			</thead>
			<tbody>
			</tbody>
