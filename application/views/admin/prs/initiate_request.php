	...
	<div class="row">
		<div class="col-md-12 col-sm-12 col-xs-12">
			...
			<?php echo form_open_multipart('prs_admin/initiate_request_action'); ?>
				...
				<div class="row">
					...
					<div class="col-md-6 col-sm-12 col-xs-12">
						...
						<div class="form-group">
							...
							<input type="text" name="acc_name" value="<?php echo set_value('acc_name', $admin_details->name); ?>" class="form-control" required />
							<div class="form-error"><?php echo form_error('acc_name'); ?></div>
						</div>
						<div class="form-group">
							<label class="form-control-label">Account Number
							<?php if ($admin_details->acc_number == NULL) { ?>
								(<a href="<?php echo base_url('prs_admin/profile'); ?>">update in profile</a>)
							<?php } ?>
							</label>
							<input type="text" name="acc_number" value="<?php echo set_value('acc_number', $admin_details->acc_number); ?>" class="form-control numbers-only" required maxlength="10" />
						...
						if ( s_country == 'Nigeria') { ?>
							...
							<div class="form-group">
								...
								<?php if ($admin_details->bank_name == NULL) { ?>
									(<a href="<?php echo base_url('admin/profile'); ?>">update in profile</a>)
								<?php } ?>
								</label>
								<select class="form-control" name="bank_name" required>
									<option selected value="<?php echo $admin_details->bank_name; ?>"><?php echo $admin_details->bank_name; ?></option>	
									<?php 
						...
						<?php } else { ?>
							...
							<div class="form-group">
								...
								<input type="text" name="bank_name" value="<?php echo set_value('bank_name', $admin_details->bank_name); ?>" class="form-control" required />
								<div class="form-error"><?php echo form_error('bank_name'); ?></div>
							</div>
