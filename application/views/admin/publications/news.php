...
<div class="row">
	<div class="col-md-12">
		...
		if ($total_records > 0) { ?>
			...
			echo modal_bulk_actions_alt('publications_admin/bulk_actions_news', $options_array); ?>
			...
			foreach ($news as $y) { ?>
				...
				$more_link = base_url('publications_admin/single_news/' . $y->id .'/'. $y->slug);

				$delete_confirm = modal_delete_confirm($y->id, $y->title, 'news article', 'publications_admin/delete_news');
				echo $delete_confirm;
				...
				<div class="row m-b-40">
					...
					<div class="col-md-8">
						...
						<div class="m-t-15">
							...
							<a type="button" class="btn btn-primary" href="<?php echo base_url('publications_admin/edit_news/'.$y->id); ?>"><i class="fa fa-pencil"></i> Edit</a>

							<a type="button" class="btn btn-primary" href="<?php echo base_url('publications_admin/'.$action); ?>"><i class="<?php echo $icon; ?>"></i> <?php echo $button_text; ?></a>
