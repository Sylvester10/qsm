			...
			<div class="row">
				...
				<div class="col-lg-6 offset-md-3 p-30 b-r-5 bg-white">
					...
					<div class="content">
						...
						<?php 
						$form_attributes = array("id" => "buy_install_form"); 
						echo form_open('installation/buy_install_ajax', $form_attributes); ?>
							...
							<div class="m-t-20">
								...
								<ul>
									...
									<li>Make your purchase using PayPal. If you do not have a PayPal account, click on <b>Pay with Debit or Credit Card</b> on the PayPal Checkout page.</li>
									
									<?php
									if ($location == 'Nigeria') { ?>
										
										<li>You'll be charged the dollar equivalent of the amount of your chosen plan on the PayPal Checkout page.</li>
										
									<?php } ?>
									
									<li>PayPal, Debit/Credit card payment attracts instant activation upon confirmation of payment.</li>
								
									<li class="text-bold f-s-17">For purchase using other modes of payment, click <a href="<?php echo base_url('buy_other'); ?>" target="_blank">here</a></li>
							...
							<div class="form-group">
								<button type="submit" class="btn btn-primary btn-lg"><i class="fa fa-paypal"></i> Install & Pay</button>
							</div>
