	 ...
	 ?>
			...
			<div class="row homework_list">
				...
				<div class="col-md-11">
					...
					<div class="m-t-20">
						<a type="button" class="btn btn-primary" href="<?php echo base_url('homework_student/view_homework/'.$y->id); ?>" title="View homework"><i class="fa fa-eye"></i> View Homework</a>
