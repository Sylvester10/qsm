...
/* ===== Documentation ===== 
Name: Kad_student_mid_term_reports
Role: Controller
...
Date Modified: 8th March, 2019
*/


class Kad_student_mid_term_reports extends MY_Controller {
    public function __construct() {
        ...
        $this->bespoke_restricted_module(school_id, kad_school_id, 'student'); 
    ...
    public function report_card($template_id, $session, $term, $class_id) {
        ...
        $this->kad_students_mid_term_report_model->check_report_template($template_id, $session, $term, $class_id, $student_id, 'student');
