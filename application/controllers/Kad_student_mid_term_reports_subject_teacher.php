...
class Kad_student_mid_term_reports_subject_teacher extends MY_Controller {
    ...
    public function students_report_ajax($session, $term, $class_id) {
        $this->load->model('ajax/staff/students_report/mid_term/'.$this->bespoke_template_folder.'/students_report_model_ajax', 'current_model');
    ...
    public function produce_test_score_pre_kg_ajax($session, $term, $class_id, $student_id) {
        ...
        $result_details = $this->kad_students_mid_term_report_model->get_result_details($session, $term, $class_id, $student_id);
    ...
    public function delete_test_score($test_score_id, $class_id) { 
        ...
        $this->kad_students_mid_term_report_model->check_approval_status($session, $term, $class_id, $student_id, $this->c_controller);
    ...
    public function report_card($template_id, $session, $term, $class_id, $student_id) {
        ...
        $this->kad_students_mid_term_report_model->check_report_template($template_id, $session, $term, $class_id, $student_id, 'staff');
        ...
        $this->kad_students_mid_term_report_model->check_report_card_ok_staff($session, $term, $class_id, $student_id);
