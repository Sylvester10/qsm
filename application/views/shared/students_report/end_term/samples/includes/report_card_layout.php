...
<div class="view_report_card">
	...
	<div class="report_template">
		...
		<?php 
		require 'application/views/shared/students_report/end_term/samples/'.$template_folder.'/data.php'; ?>
		...
		require "application/views/shared/students_report/end_term/samples/includes/other_template_links.php"; ?>
