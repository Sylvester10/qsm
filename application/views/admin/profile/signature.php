...
<?php echo custom_validation_errors(); ?>
	...
	<div class="row">
		...
		<div class="col-md-7">
			...
			Note: This signature will be appended on reports that you approve.
			<?php
			if ($y->signature == NULL) { ?>
				<p class="text-danger">The default signature is still in use. Change to your signature.</p>
			<?php } ?>
			
			<?php echo form_open_multipart('admin/update_signature'); ?>
			
				<div class="form-group">
					<div id="current_image_area" class="m-b-10">
						<?php
						if ($y->signature != NULL) { ?>
							<img id="current_image" src="<?php echo base_url('assets/uploads/signature/admins/'.$y->signature); ?>" />
						<?php } else { ?>
							<img id="current_image" src="<?php echo admin_signature; ?>" />
						<?php } ?>
					</div>
