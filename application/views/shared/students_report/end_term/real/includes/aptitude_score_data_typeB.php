									...
									<table class="report_inner_table">
										...
										<tbody>
											...
											foreach ($aptitude_scores as $p) {
												...
												$aptitude_id = $p->aptitude_id; 
												$score = $p->score;
												$aptitude_details = $this->common_model->get_aptitude_details($aptitude_id);
												$aptitude = $aptitude_details->aptitude; 
												$domain = $aptitude_details->domain; 
