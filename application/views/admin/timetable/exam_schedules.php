...
<?php require("application/views/admin/timetable/modals/exam_schedules_actions.php");  ?>
...
<h3>Note</h3>
<p>Dates with exam schedules are in green background. Click on the cell to see schedule details.</p>

<div class="calendar_responsive">	
	<?php echo $exam_schedules; ?>
</div>
