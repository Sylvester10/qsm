...
/* ===== Documentation ===== 
Name: Child_class_model_ajax
Role: Ajax model for jQuery DataTables
Description: Handles ajax DB processes of students in a given class in parent's dashboard
...
class Child_class_model_ajax extends CI_Model {
