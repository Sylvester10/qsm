		...
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<h4 class="text-bold f-s-20"><?php echo $child_name; ?></h4>
					...
					<div class="">
						...
						<?php 
						$limit = 10;
						$recent_attendance = $this->school_parent_model->get_recent_attendance($class_id, $child_id, $limit);
					...
					echo form_open('parent/check_attendance_ajax/'.$child_id, $form_attributes); ?>
