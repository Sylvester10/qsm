...
<div class="new-item m-b-30">
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('homework_subject_teacher/view_homework/'.$y->id); ?>" ><i class="fa fa-eye"></i> View Homework</a>
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('homework_subject_teacher/homework/'.$y->class_id); ?>" ><i class="fa fa-tasks"></i> All Homework</a>
</div>
		
<?php 
echo form_open_multipart('homework_subject_teacher/edit_homework_action/'.$y->id); ?>
		...
		<div class="col-md-4 col-sm-12 col-xs-12">
			...
			<div class="form-group">
				...
				<?php if ($y->material != NULL) { ?>
					...
					<a href="<?php echo base_url('homework_subject_teacher/delete_homework_material/'.$y->id); ?>" class="underline-link m-l-5">delete</a>
				<?php } ?>
