			...
			<div class="form-holder has-shadow">
				<div class="row">
					...
					<div class="col-lg-6 bg-white switch-user">
						...
						<h3 class="text-center"><i class="fa fa-lock"></i> Set Parent Password</h3>
						<div class="form d-flex align-items-center">
							<div class="content">
								
								<?php
								//process form asynchronously using AJAX
								$form_attributes = array("id" => "set_pass_parent_form");
								echo form_open('parent_acc/set_password_ajax', $form_attributes); ?>
