...
/* ===== Documentation ===== 
Name: Admin_users_model_ajax
Role: Ajax model for jQuery DataTables
Description: Handles ajax DB processes of admin users
...
class Admin_users_model_ajax extends CI_Model {
	...
	var $table = 'admins';
	var $column_order = array(null, 'id', 'name', 'email', 'phone', 'designation', 'level'); //set column field database for datatable orderable
	var $column_search = array('id', 'name', 'email', 'phone', 'designation', 'level'); //set column field database for datatable searchable 
	...
	public function actions($id) {
		return '<p><a type="button" href="' . base_url('admin_users/edit_admin/'.$id) .'" class="btn btn-default btn-sm btn-block action-btn clickable"> <i class="fa fa-pencil" style="color: green"></i> &nbsp; Edit Admin </a></p>

		<p><a type="button" href="#" class="btn btn-default btn-sm btn-block action-btn clickable" data-toggle="modal" data-target="#message'.$id.'"> <i class="fa fa-envelope" style="color: green"></i> &nbsp; Message Admin </a></p>
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="' .base_url('admin_users/delete_admin/'.$id). '"> Yes, Delete </a>
