...
<p>Number of Parents: <?php echo $total_users; ?></p>
...
<div class="m-b-20">
	...
	<div class="table-scroll">
		<table id="school_parents_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
			...
			<thead>
				<tr>
					...
					<th class="min-w-100"> Phone Number </th>
					<th class="min-w-150"> Number of Children </th>
