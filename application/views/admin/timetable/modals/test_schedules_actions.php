		...
		<div class="modal-dialog">
			<div class="modal-content modal-form-sm">
				<div class="modal-header">
					...
					<h4 class="modal-title">New Test Schedule</h4>
				</div><!--/.modal-header-->
				<div class="modal-body">
					<?php 
					$form_attributes = array("id" => "new_test_schedule_form");
					echo form_open('timetable_admin/new_test_schedule_ajax', $form_attributes); ?>
	...
	<div class="modal fade" id="clear" role="dialog">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					Are you sure you want to clear all test schedules? This action will delete all the records. <br />
				</div>
				<div class="modal-footer">
					<a class="btn btn-sm btn-danger" role="button" href="<?php echo base_url('timetable_admin/clear_test_schedules'); ?>"> Yes, Clear All </a>
