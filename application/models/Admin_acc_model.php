...
/* ===== Documentation ===== 
Name: Admin_acc_model
Role: Model
Description: Controls the DB processes of admin account
Controller: Admin_acc
...
class Admin_acc_model extends CI_Model {
    ...
    public function update_pass_reset_code($admin_id, $pass_reset_code) {
        $data = array (
    ...
    public function validate_pass_reset_code($admin_id, $pass_reset_code) {
        //validate password reset code
        $code = $this->common_model->get_admin_details_by_id($admin_id)->pass_reset_code;
