	...
	echo modal_bulk_actions('school_account/bulk_actions_schools', $options_array); ?>
		...
		<table id="expired_annual_subscription_schools_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
			...
			<thead>
				<tr>
					...
					<th class="min-w-100"> Date Expired</th>
				</tr>
			</thead>
			<tbody>
			</tbody>
