...
<?php echo flash_message_danger('status_msg_error'); ?>
    ...
    <div class="row">
        ...
        <div class="col-md-12 p-b-30 table-scroll">
            ...
            <?php
            $method = 'produce_test_score_kg_skg_primary_ajax';
            ...
            echo form_open($produce_report_url, $form_attributes); ?>
                ...
                <table class="table table-bordered cell-text-middle" style="text-align: left">
                    <thead>
                        <tr>
                            <th class="w-3">S/N</th>
                            <th class="min-w-200">Subjects</th>
                            <th class="min-w-40">Assessment (100)</th>
                            <th class="min-w-150">Remark</th>
                        ...
                        foreach ($subjects as $s) { 
                            ...
                            <tr>
                                ...
                                <?php if ($test_score_query->num_rows() == 0) { ?>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input class="form-control numbers-only assessment_field assessment_score" type="text" name="assessment[]" value="<?php echo set_value('assessment[]'); ?>" maxlength="3" />
                                        </div>
                                    </td>

                                    <td>
                                        <div class="form-group">
                                            <input class="form-control assessment_remark" type="text" id="kg_pri_subject_remark" readonly />
                                        </div>
                                    </td>
                                ...
                                <?php } else { 
                                    ...
                                    $remark = $this->kad_students_mid_term_report_model->get_kg_primary_test_score_rubric($session, $term, $class_id, $student_id, $t->assessment, 'remark'); ?>

                                    <td>
                                        <div class="form-group">
                                            <input class="form-control numbers-only assessment_field assessment_score" type="text" name="assessment[]" value="<?php echo set_value('assessment[]', $t->assessment); ?>" maxlength="3" />
                                        </div>
                                    </td>

                                    <td>
                                        <div class="form-group">
                                            <input class="form-control assessment_remark" type="text" id="kg_pri_subject_remark" value="<?php echo $remark; ?>" readonly />
                                        </div>
                                    </td>
