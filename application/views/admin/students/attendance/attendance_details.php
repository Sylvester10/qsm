...
<?php echo custom_validation_errors(); ?>
	...
	<div class="new-item">
		<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('students_admin/attendance/'.$session.'/'.$term.'/'.$slug); ?>"><i class="fa fa-histroy"></i> Mark Attendance</a>
	</div>
		...
		<div class="col-md-6 col-md-offset-3">
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<h3 class="text-bold">Student Name: <?php echo $student_name; ?></h3>
					...
					<div class="">
						...
						<?php 
						$limit = 10;
						$recent_attendance = $this->students_admin_model->get_recent_attendance($session, $term, $class_id, $id, $limit);
					...
					echo form_open('students_admin/check_attendance_ajax/'.$id, $form_attributes); ?>
