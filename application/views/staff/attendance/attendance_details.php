...
<?php echo custom_validation_errors(); ?>
	...
	<div class="new-item">
		<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('class_teacher/attendance'); ?>"><i class="fa fa-histroy"></i> Mark Attendance</a>
	</div>
			...
			<div class="x_panel">
				...
				<div class="x_content">
					...
					<div class="">
						...
						<?php 
						$limit = 10;
						$recent_attendance = $this->class_teacher_model->get_recent_attendance($id, $limit);
					...
					echo form_open('class_teacher/check_attendance_ajax/'.$id, $form_attributes); ?>
