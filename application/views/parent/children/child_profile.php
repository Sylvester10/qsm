...
<div class="row">
	...
	<div class="col-md-4">
		...
		<p><b>Password Reset Code:</b> <?php echo $y->pass_reset_code; ?> <small>(Use this to reset <?php echo $y->first_name; ?>'s student account password should it be forgotten. Copy and keep in a safe place)</small></p>
	</div>
