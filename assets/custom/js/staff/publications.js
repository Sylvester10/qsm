jQuery(document).ready(function ($) {
 "use strict";
	...
	$('#create_general_announcement_form').submit(function(e) {
		...
		$.ajax({
			url: base_url + 'publications_staff/create_general_announcement_ajax', 
			type: 'POST',
			data: form_data, 
	...
	$('#update_general_announcement_form').submit(function(e) {
		...
		var form_data = $(this).serialize();
		$.ajax({
			url: base_url + 'publications_staff/update_general_announcement_ajax', 
			type: 'POST',
			data: form_data, 
			success: function(msg) {
				if (msg == 1) {
	...
	$('#create_staff_announcement_form').submit(function(e) {
		...
		var form_data = $(this).serialize();
		$.ajax({
			url: base_url + 'publications_staff/create_staff_announcement_ajax', 
			type: 'POST',
			data: form_data, 
			success: function(msg) {
				if (msg == 1) {
	...
	$('#update_staff_announcement_form').submit(function(e) {
		...
		var form_data = $(this).serialize();
		$.ajax({
			url: base_url + 'publications_staff/update_staff_announcement_ajax', 
			type: 'POST',
			data: form_data, 
			success: function(msg) {
				if (msg == 1) {
	...
	$('#create_term_date_form').submit(function(e) {
		...
		$.ajax({
			url: base_url + 'publications_staff/create_term_date_ajax', 
			type: 'POST',
			data: form_data, 
			success: function(msg) {
				if (msg == 1) {
	...
	$('#create_calendar_date_form').submit(function(e) {
		...
		$.ajax({
			url: base_url + 'publications_staff/create_calendar_date_ajax', 
			type: 'POST',
			data: form_data, 
			success: function(msg) {
				if (msg == 1) {
	...
	var term_dates_table = $('#term_dates_table').DataTable({ 
		...
		ajax: {
			url: base_url + 'publications_staff/term_dates_ajax',
			dataType: "json",
			type: "POST",
