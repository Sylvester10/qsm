...
<?php require("application/views/admin/publications/modals/calendar_date_actions.php");  ?>
	...
	<div class="col-md-2">
		<div class="pull-right">
			<div class="pull-right m-b-10">
				<div class="new-item">
					<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('publications_admin/calendar_dates'); ?>"><i class="fa fa-calendar"></i> Calendar Grid</a>
				</div>
			</div>
		</div>
	</div>
...
echo modal_bulk_actions_alt('publications_admin/bulk_actions_calendar_dates', $options_array); ?>
	...
	if ($total_records > 0) { 
		...
		foreach ($calendar_list as $y) { 
			...
			require "application/views/admin/publications/modals/manage_calendar.php"; 
			//delete confirm modal
			echo modal_delete_confirm($y->id, $y->caption, 'event', 'publications_admin/delete_calendar_date'); ?>
