...
Description: Handles ajax DB processes of end-of-term students reports in a given class in admin's dashboard
Controller: Student_report_admin
...
class Students_report_model_ajax extends CI_Model {
	...
	public function approve_actions($result_id) {
		$r = $this->students_report_model->get_result_details_by_id($result_id);
