        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="manage_reports">
                ...
                if ($this->c_user_role == 'admin' || $this->c_user_role == 'class_teacher') { ?>
                    ...
                    <div class="new-item">
                        <a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url($this->c_controller.'/class_broadsheet/'.$session.'/'.$term.'/'.$class_id); ?>"><i class="fa fa-newspaper-o"></i> View Class Broadsheet</a>
                    </div>
                ...
                //check if admin
                if ($this->c_user == 'admin') { 
                    require "application/views/shared/students_report/end_term/real/modals/bulk_actions_students_report.php";
                } //if admin ?>
                        ...
                        <table id="students_report_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
                            ...
                            <thead>
                                <tr>
                                    ...
                                    <th> Resumption Class </th>
                                    <th class="min-w-200"> Class Teacher's Comment </th>
                                    <th class="min-w-200"> Head Teacher's Comment </th>
                                </tr>
                            </thead>
                            <tbody>
                            </tbody>
            ...
            <div class="tab-pane" id="new_report">
                <?php echo get_students_new_report($session, $term, $class_id, TRUE); ?>
            </div><!--/#new_report-->
