...
Description: Handles ajax DB processes of all books in admin's dashboard
...
class All_books_model_ajax extends CI_Model {
	...
	public function actions($book_id) {
		$y = $this->school_library_model->get_book_details_by_id($book_id);
		return '<p><a type="button" class="btn btn-default btn-sm btn-block action-btn clickable" href="' . base_url('school_library_admin/edit_book/'.$book_id) .'"> <i class="fa fa-pencil" style="color: green"></i> &nbsp; Edit Book </a></p>
	...
	public function lend_book_form_student($book_id) {
		...
		return form_open('school_library_admin/lend_book_student/'.$book_id).
			'<div class="m-b-10">
	...
	public function lend_book_form_staff($book_id) {
		...
		return form_open('school_library_admin/lend_book_staff/'.$book_id).
			'<div class="m-b-10">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="' .base_url('school_library_admin/delete_book/'.$book_id). '"> Yes, Delete </a>
