...
Description: Handles ajax DB processes of end-term students reports in a given class in staff's dashboard
Controller: Kad_student_end_term_reports_[class_teacher, subject_teacher]
Bespoke: KAD Academy
