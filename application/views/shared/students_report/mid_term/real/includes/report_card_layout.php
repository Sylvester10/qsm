...
if ($this->c_user == 'admin') { ?>
	...
	<div class="new-item">
		...
		<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('sections/edit_section/'.$section_id); ?>#mt_report_card_settings" target="_blank"><i class="fa fa-wrench"></i> Customize Report Card</a>
	</div>
...
<div class="view_report_card">
	...
	<div class="report_template">
		...
		require 'application/views/shared/students_report/mid_term/real/'.$template_folder.'/data.php'; ?>
