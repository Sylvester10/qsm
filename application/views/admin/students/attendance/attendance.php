...
<?php echo custom_validation_errors(); ?>
	...
	<?php echo form_open('students_admin/mark_attendance/'.$session.'/'.$term.'/'.$class_id); ?>
				...
				<table class="table table-bordered cell-text-middle" style="text-align: left">
					...
					<tbody>
						...
						foreach ($students as $s) {
							...
							<tr>
								<td><a class="btn btn-primary" href="<?php echo base_url('students_admin/attendance_details/'.$session.'/'.$term.'/'.$slug.'/'.$s->id); ?>" target="_blank" title="View details"><i class="fa fa-history"></i></td>
								...
								<td class="text-bold">
									...
									<?php 
									$limit = 3;
									$recent_attendance = $this->students_admin_model->get_recent_attendance($session, $term, $class_id, $student_id, $limit);
