...
<div class="new-item">
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('school_publications_student/calendar_dates'); ?>"><i class="fa fa-calendar"></i> Calendar Grid</a>
</div>
