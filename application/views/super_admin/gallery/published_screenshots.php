...
<div class="new-item">
	...
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('gallery/screenshots'); ?>"><i class="fa fa-image"></i> All Screenshots</a>
</div>	
...
<?php } else { ?>
	...
	<h3 class="text-danger">No published screenshot to show.</h3>
