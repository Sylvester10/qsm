...
/* ===== Documentation ===== 
Name: Student_mid_term_reports_parent
Role: Controller
...
class Student_mid_term_reports_parent extends MY_Controller {
    ...
    public function report_card($template_id, $session, $term, $class_id, $student_id) {
        ...
        $this->students_mid_term_report_model->check_report_template($template_id, $session, $term, $class_id, $student_id, 'school_parent');
