...
<p>Number of Staff: <?php echo $total_users; ?></p>
...
<div class="m-b-20">
	...
	<div class="table-scroll">
		<table id="school_staff_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
