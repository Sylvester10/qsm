...
Description: Handles ajax DB processes of staff notifications
Controller: Staff
...
class Notifs_model_ajax extends CI_Model {
	...
	public function options($id) {
		return '<a type="button" href="#" class="btn btn-danger btn-sm modal-toggle-btn clickable m-t-15" data-toggle="modal" data-target="#delete'.$id.'" title="Delete Notification"> <i class="fa fa-trash"></i> </a>';
	}
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-danger" href="' .base_url('staff/delete_notif/'.$id). '"> Yes, Delete </a>
