			...
			<div class="row">
				...
				<div class="col-lg-6 offset-md-3 p-30 b-r-5 bg-white">
					...
					<div class="content">
						...
						<div class="m-t-20">
							When you click the <b>Buy</b> button below this form, your school account will be created. You will be able to contninue your payment when logged in. Account information and directive on making payment will be given to you.
							<h4 class="text-bold f-s-17 m-t-20">For purchase using debit/credit card payment, click <a href="<?php echo base_url('buy'); ?>" target="_blank">here</a></h4> 
						</div>
						
						<?php 
						$form_attributes = array("id" => "buy_other_install_form"); 
						echo form_open('installation/buy_other_install_ajax', $form_attributes); ?>
							...
							<div class="text-center">
								<img class="payment_logo_other img-responsive" src="<?php echo base_url('assets/images/payment_other.jpg'); ?>" />
							</div>
