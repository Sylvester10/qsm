			...
			<div class="form-holder has-shadow">
				<div class="row">
					...
					<div class="col-lg-6 bg-white switch-user">
						...
						<h3 class="text-center"><i class="fa fa-unlock"></i> Parent Password Reset</h3>
						<div class="form d-flex align-items-center">
							<div class="content">
								...
								<?php } else { //code is valid and not expired, show form ?>
									...
									$form_attributes = array("id" => "change_pass_parent_form");
									echo form_open('parent_acc/change_password_ajax/'.$y->id, $form_attributes); ?>
										
										<input type="hidden" id="parent_id" value="<?php echo $y->id; ?>" />
