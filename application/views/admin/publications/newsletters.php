...
<div class="row">
	<div class="col-md-12">
		...
		<div class="new-item">
			<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('publications_admin/create_newsletter'); ?>"><i class="fa fa-plus"></i> Create Newsletter</a>
		</div>
		...
		echo modal_bulk_actions_alt('publications_admin/bulk_actions_newsletters', $options_array); ?>
			...
			if ($total_records > 0) { 
				...
				foreach ($newsletters as $y) { 
					...
					$delete_confirm = modal_delete_confirm($y->id, $y->title, 'newsletter', 'publications_admin/delete_newsletter');
					echo $delete_confirm;
