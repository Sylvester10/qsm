				...
				<div class="form-group">
					...
					<select class="form-control" name="title">
						...
						foreach ($titles as $title) { 
							$selected = ($title == $y->title) ? 'selected' : NULL; ?>
							<option <?php echo $selected; ?> value="<?php echo $title; ?>" <?php echo set_select('title', $title); ?> ><?php echo $title; ?></option>
						<?php } ?>
				...
				<div class="form-group">
					...
					<select class="form-control" name="qualification">
						...
						foreach ($qualifications as $qualification) { 
							$selected = ($qualification == $y->qualification) ? 'selected' : NULL; ?>
							<option <?php echo $selected; ?> value="<?php echo $qualification; ?>" <?php echo set_select('qualification', $qualification); ?> ><?php echo $qualification; ?></option>
						<?php } ?>
