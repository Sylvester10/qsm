...
/* ===== Documentation ===== 
Name: Kad_student_end_term_reports
Role: Controller
...
class Kad_student_end_term_reports extends MY_Controller {
    ...
    public function check_result() {
        $this->student_header('Check End-of-Term Result', 'Check End-of-Term Result');
        ...
        $this->load->view('student/reports/end_term/check_result', $data);
        $this->student_footer();
    }
    ...
    public function report_card($template_id, $session, $term, $class_id) {
        ...
        $this->kad_students_end_term_report_model->check_report_template($template_id, $session, $term, $class_id, $student_id, 'student');
