...
<div class="row">
	<div class="col-md-6">
		...
		<?php 
		$form_attributes = array("id" => "check_mid_term_result_form");
		echo form_open($this->c_controller.'/check_result_ajax', $form_attributes); ?>
			...
			<div class="form-group">
				<label class="form-control-label">Class <small>(your class in selected session and term)</small></label>
