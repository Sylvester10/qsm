			...
			<div class="form-holder has-shadow">
				<div class="row">
					...
					<div class="col-lg-6 bg-white switch-user">
						...
						<h3 class="text-center"><i class="fa fa-unlock"></i> Super Admin Password Recovery</h3>
						<div class="form d-flex align-items-center">
							<div class="content">
							
								<?php
								//process form asynchronously using AJAX
								$form_attributes = array("id" => "recover_pass_super_admin_form");
								echo form_open('super_admin_acc/recover_password_ajax', $form_attributes); ?>
									<div class="form-group">
										<label>Email</label>
										<input type="email" name="email" id="super_admin_email" class="form-control p-l-10" required>	
									</div>
								...
								<div>
									<ul class="home_links_super_admin">
										...
										<li><a href="<?php echo base_url('super_admin_login'); ?>">Login</a></li>
