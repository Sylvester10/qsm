...
<div class="new-item m-b-30">
	<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('homework_admin/new_homework/'.$slug); ?>" ><i class="fa fa-plus"></i> New Homework</a>
</div>
...
<?php
	if ($total_records > 0) {  
		...
		echo modal_bulk_actions_alt('homework_admin/bulk_actions_homework', $options_array); 
	} ?>
	...
	if ($total_records > 0) { 
		foreach ($homework as $y) {
			...
			echo modal_delete_confirm($y->id, $subject, 'homework', 'homework_admin/delete_homework'); ?>
			...
			<div class="row homework_list">
				...
				<div class="col-md-11">
					...
					<div class="m-t-20">
						<a type="button" class="btn btn-primary" href="<?php echo base_url('homework_admin/view_homework/'.$y->id); ?>" title="View homework"><i class="fa fa-eye"></i></a>
						...
						<a type="button" class="btn btn-primary" href="<?php echo base_url('homework_admin/edit_homework/'.$y->id); ?>" title="Edit homework"><i class="fa fa-pencil"></i></a>
