...
<?php echo flash_message_danger('status_msg_error'); ?>
    ...
    <p>Note: If <b>Assessment Score</b> is not provided for a given subject, the result for that subject will not be submitted.</p>
    ...
    <div class="row">
        ...
        <div class="col-md-12 p-b-30 table-scroll">
            ...
            <?php
            $method = 'produce_test_score_'.$category.'_ajax';
                ...
                <table class="table table-bordered cell-text-middle" style="text-align: left">
                    <thead>
                        <tr>
                            ...
                            <th class="min-w-20">Effort (3)</th>
                            <th class="min-w-20">Behaviour (3)</th>
                            <th class="min-w-40">Assessment (100)</th>
                            <th class="min-w-200">Progress </th>
                            <th class="min-w-300">Subject Comment <br /><small>(400 characters max)</small></th>
                        ...
                        foreach ($subjects as $s) { 
                            ...
                            <tr>
                                ...
                                <?php if ($test_score_query->num_rows() == 0) { ?>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input class="form-control numbers-only progress_field" type="text" name="effort[]" value="<?php echo set_value('effort[]'); ?>" maxlength="1" />
                                        </div>
                                    </td>

                                    <td>
                                        <div class="form-group">
                                            <input class="form-control numbers-only progress_field" type="text" name="behaviour[]" value="<?php echo set_value('behaviour[]'); ?>" maxlength="1" />
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input class="form-control assessment_remark" type="text" id="kg_sec_subject_remark" readonly />
                                        </div>
                                    </td>
                                ...
                                <?php } else { 
                                    ...
                                    $remark = $this->kad_students_mid_term_report_model->get_secondary_test_score_rubric($session, $term, $class_id, $student_id, $t->assessment, 'remark'); ?>

                                    <td>
                                        <div class="form-group">
                                            <input class="form-control numbers-only progress_field" type="text" name="effort[]" value="<?php echo set_value('effort[]', $t->effort); ?>" maxlength="1" />
                                        </div>
                                    </td>

                                    <td>
                                        <div class="form-group">
                                            <input class="form-control numbers-only progress_field" type="text" name="behaviour[]" value="<?php echo set_value('behaviour[]', $t->behaviour); ?>" maxlength="1" />
                                        </div>
                                    </td>
                                    ...
                                    <td>
                                        <div class="form-group">
                                            <input class="form-control assessment_remark" type="text" id="kg_sec_subject_remark" value="<?php echo $remark; ?>" readonly />
                                        </div>
                                    </td>
