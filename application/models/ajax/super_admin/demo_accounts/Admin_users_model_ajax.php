...
Description: Handles ajax DB processes of demo admin users
...
class Admin_users_model_ajax extends CI_Model {
	...
	public function actions($id) {
		return '<p><a type="button" href="' . base_url('demo_accounts/super_user_login_admin/'.$id) .'" class="btn btn-default btn-sm btn-block action-btn clickable" target="_blank"> <i class="fa fa-sign-in" style="color: green"></i> &nbsp; Login as Super User </a></p>
	...
	public function edit_admin_form($id) {
		$y = $this->common_model->get_admin_details_by_id($id);
		return form_open('demo_accounts/edit_admin/'.$id).
			'<div class="m-b-10">
	...
	public function modal_edit_admin($id) {
		$y = $this->common_model->get_admin_details_by_id($id);
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="' .base_url('demo_accounts/delete_admin/'.$id). '"> Yes, Delete </a>
