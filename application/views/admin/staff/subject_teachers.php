...
<?php echo custom_validation_errors(); ?>
	...
	echo modal_bulk_actions('school_staff/delete_bulk_subject_teachers', $options_array); ?>
	
	<div class="table-scroll">
		<table id="subject_teachers_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
			...
			<thead>
				<tr>
					...
					<th class="min-w-150"> Class(es) Assigned </th>
					<th class="min-w-150"> Subject(s) Assigned </th>
				</tr>
			</thead>
			<tbody>
			</tbody>
