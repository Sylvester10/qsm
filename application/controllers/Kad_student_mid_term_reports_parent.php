...
/* ===== Documentation ===== 
Name: Kad_student_mid_term_reports_parent
Role: Controller
...
class Kad_student_mid_term_reports_parent extends MY_Controller {
    ...
    public function check_result($student_id) {
        ...
        $this->parent_header('Check Mid-Term Result', 'Check Mid-Term Result');
        ...
        $data['result_sessions'] = $this->kad_students_mid_term_report_model->get_student_result_sessions($student_id);
        $data['current_class_id'] = $this->common_model->get_student_details_by_id($student_id)->class_id;
        $this->load->view('parent/reports/mid_term/check_result', $data);
        $this->parent_footer();
    }
    ...
    public function check_result_ajax($student_id) { 
        ...
        if ($this->form_validation->run() == FALSE) {
            ...
            $query = $this->kad_students_mid_term_report_model->get_result_details($session, $term, $class_id, $student_id);
    ...
    public function report_card($template_id, $session, $term, $class_id, $student_id) {
        ...
        $this->kad_students_mid_term_report_model->check_report_template($template_id, $session, $term, $class_id, $student_id, 'school_parent');
