...
Description: Handles ajax DB processes of school admin users
...
class Admin_users_model_ajax extends CI_Model {
	...
	public function actions($id) {
		return '<p><a type="button" href="' . base_url('school_users/super_user_login_admin/'.$id) .'" class="btn btn-default btn-sm btn-block action-btn clickable" target="_blank"> <i class="fa fa-pencil" style="color: green"></i> &nbsp; Login as Super User </a></p>';
	}
