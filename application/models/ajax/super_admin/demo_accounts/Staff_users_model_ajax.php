...
/* ===== Documentation ===== 
Name: Staff_users_model_ajax
Role: Ajax model for jQuery DataTables
Description: Handles ajax DB processes of demo staff users
...
class Staff_users_model_ajax extends CI_Model {
	...
	var $table = 'staff';
	var $column_order = array(null, 'id', 'name', 'email', 'phone', 'designation', 'role'); //set column field database for datatable orderable
	var $column_search = array('id', 'name', 'email', 'phone', 'designation', 'role'); //set column field database for datatable searchable 
	...
	public function actions($id) {
		return '<p><a type="button" href="' . base_url('demo_accounts/super_user_login_staff/'.$id) .'" class="btn btn-default btn-sm btn-block action-btn clickable" target="_blank"> <i class="fa fa-sign-in" style="color: green"></i> &nbsp; Login as Super User </a></p>
	...
	private function demo_roles($demo_role) {
		//get staff demo roles
		$roles = demo_roles_staff();
		$role_options ="";
	...
	public function edit_staff_form($id) {
		$y = $this->common_model->get_staff_details_by_id($id);
		return form_open('demo_accounts/edit_staff/'.$id).
			'<div class="m-b-10">
	...
	public function modal_edit_staff($id) {
		$y = $this->common_model->get_staff_details_by_id($id);
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-footer">
						<a class="btn btn-sm btn-danger" role="button" href="' .base_url('demo_accounts/delete_staff/'.$id). '"> Yes, Delete </a>
