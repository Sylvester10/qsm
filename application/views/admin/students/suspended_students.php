...
<?php echo custom_validation_errors(); ?>
	...
	<div class="row">
		...
		<div class="col-md-6 col-md-offset-3">
			<div class="pull-right m-t-10 m-b-10">
				...
				<p>Suspended: <?php echo $total_suspended_students; ?></p>
	...
	<div class="table-scroll">
		<table id="suspended_students_table" class="table table-bordered table-hover cell-text-middle" style="text-align: left">
			...
			<thead>
				<tr>
					...
					<th class="min-w-200"> Reason for Suspension </th>
					<th class="min-w-150"> Duration of Suspension </th>
					<th class="min-w-150"> Date Suspended </th>
