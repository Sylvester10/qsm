		...
		<div class="col-md-2">
			<div class="pull-right">
				<div class="pull-right m-b-10">
					<div class="new-item">
						<a class="btn btn-default btn-sm button-adjust" href="<?php echo base_url('publications_admin/calendar_dates_list'); ?>"><i class="fa fa-calendar"></i> Calendar List</a>
					</div>
				</div>
			</div>
		</div>
...
<p>To manage events, view <a href="<?php echo base_url('publications_admin/calendar_dates_list'); ?>">Calendar List</a>.</p>
