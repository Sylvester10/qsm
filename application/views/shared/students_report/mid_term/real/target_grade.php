...
<div class="row">
	...
	<div class="col-md-8 p-b-30 table-scroll">
        ...
        $form_attributes = array('id' => 'produce_mid_term_target_grade_form'); 
			...
			<table class="table table-bordered cell-text-middle" style="text-align: left">
				...
				<tbody>
					...
					foreach ($subjects as $s) { 
						...
						$query = $this->students_mid_term_report_model->check_target_grade_exists($session, $term, $class_id, $student_id, $subject_id); ?>
