        ...
        <footer>
			...
			<?php 
			//require wix answers widget
			require "application/views/shared/apis/wix_answers.php"; ?>
    ...
    //student search script in header
    echo admin_module_level_scripts('s_student_search') . "\r\n"; ?>
